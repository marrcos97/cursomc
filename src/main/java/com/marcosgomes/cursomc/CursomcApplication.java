package com.marcosgomes.cursomc;
...
import com.marcosgomes.cursomc.domain.Endereco;
import com.marcosgomes.cursomc.domain.Estado;
import com.marcosgomes.cursomc.domain.ItemPedido;
import com.marcosgomes.cursomc.domain.Pagamento;
import com.marcosgomes.cursomc.domain.PagamentoComBoleto;
import com.marcosgomes.cursomc.domain.PagamentoComCartao;
import com.marcosgomes.cursomc.domain.Pedido;
import com.marcosgomes.cursomc.domain.Produto;
import com.marcosgomes.cursomc.domain.enuns.EstadoPagamento;
import com.marcosgomes.cursomc.domain.enuns.TipoCliente;
import com.marcosgomes.cursomc.repositories.CategoriaRepository;
import com.marcosgomes.cursomc.repositories.CidadeRepository;
import com.marcosgomes.cursomc.repositories.ClienteRepository;
import com.marcosgomes.cursomc.repositories.EnderecoRepository;
import com.marcosgomes.cursomc.repositories.EstadoRepository;
import com.marcosgomes.cursomc.repositories.ItemPedidoRepository;
import com.marcosgomes.cursomc.repositories.PagamentoRepository;
import com.marcosgomes.cursomc.repositories.PedidoRepository;
import com.marcosgomes.cursomc.repositories.ProdutoRepository;
...
public class CursomcApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        final Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        final Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        final Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
